...
exports.handler = (event, context, callback) => {
  ...
  const s3Bucket = event.s3Bucket || "onehandapp-downloader";
  ...
  Promise.resolve()
    ...
    .then(() => {
      ...
      const ffmpegArgs = [
        ...
        "-acodec",
        "libmp3lame", // Use Lame for the mp3 encoding.
        "-ac",
        "2", // Set 2 audio channels.
        "-q:a",
        "6", // Set the quality to be roughly 128 kb/s.
        mp3Filename
      ];
